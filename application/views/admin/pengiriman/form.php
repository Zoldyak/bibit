<div class="container">
  ...
  if ($jenis_form=='tambah') {?>
    ...
    <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal"  action="<?php echo base_url('admin/CA_Pengiriman/tambah')?> " method="post">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="hidden" class="form-control" id="inputEmail3" placeholder="Email" name="aksi" value="tambah">
                    <input type="hidden" class="form-control" id="inputEmail3" placeholder="Email" name="tipe" value="Pengiriman">
                </div>
              </div>
              <!-- /.box-body -->
  ...
  <?php }
      ...
      <div class="box box-success">
              ...
              <form class="form-horizontal"  action="<?php echo base_url('admin/CA_Pengiriman/edit')?> " method="post">
                <div class="box-body">
                  <div class="form-group">
